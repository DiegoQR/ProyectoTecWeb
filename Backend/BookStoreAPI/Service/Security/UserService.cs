using BookStoreAPI.Models.Security;
...
namespace BookStoreAPI.Service.Security
{
    public class UserService : IUserService
    {
        ...
        public async Task<UserManagerResponse> CreateUserRoleAsync(CreateUserRoleViewModel model)
        {
            ...
            return new UserManagerResponse
            {
                Token = "Unexpected role asignation error",
                IsSuccess = false
            };
        }
        ...
        public async Task<UserManagerResponse> LoginUserAsync(LoginViewModel model)
        {
            ...
            var confKey = configuration["AuthSettings:Key"];
